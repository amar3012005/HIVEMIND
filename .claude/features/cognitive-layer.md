...
**Group:** Workspace Admin · **Route:** `/hivemind/app/engine`
**Status:** UNAUDITED — no production review yet

## Frontend
- `pages/Engine.jsx`

## Backend endpoints called (5)
- `/v1/proxy/cognitive-frame`
- `/v1/proxy/consensus/evaluate`
- `/v1/proxy/swarm/follow`
- `/v1/proxy/temporal/as-of`
- `/v1/proxy/temporal/diff`
