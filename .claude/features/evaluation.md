...
**Group:** Advanced · **Route:** `/hivemind/app/evaluation`
**Status:** UNAUDITED — no production review yet

## Frontend
- `pages/Evaluation.jsx`

## Backend endpoints called (7)
- `/v1/proxy/connectors/gmail/status`
- `/v1/proxy/evaluate/history`
- `/v1/proxy/evaluate/results`
- `/v1/proxy/evaluate/retrieval`
- `/v1/proxy/memories`
- `/v1/proxy/profile`
- `/v1/proxy/search/quick`
