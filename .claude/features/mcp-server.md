...
**Group:** Advanced · **Route:** `/hivemind/app/mcp`
**Status:** UNAUDITED — no production review yet

## Frontend
- `pages/McpServer.jsx`
- `pages/McpConnectCallback.jsx`
- `pages/ClaudeCodeConnectCallback.jsx`

## Backend endpoints called (0)
_none detected via apiClient_
