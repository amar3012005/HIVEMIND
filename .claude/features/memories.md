...
- `/v1/bootstrap`
- `/v1/proxy/documents`
- `/v1/proxy/documents/${id}`
- `/v1/proxy/documents/search`
- `/v1/proxy/evidence/hybrid`
- `/v1/proxy/evidence/memory`
- `/v1/proxy/evidence/search`
- `/v1/proxy/memories`
- `/v1/proxy/memories/${id}`
- `/v1/proxy/memories/${id}${hard`
- `/v1/proxy/profile`
