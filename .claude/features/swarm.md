...
**Group:** Operating System · **Route:** `/hivemind/app/swarm`
**Status:** UNAUDITED — no production review yet

## Frontend
- `pages/AgentSwarm.jsx`
- `pages/SwarmGovernance.jsx`

## Backend endpoints called (12)
- `/v1/proxy/governance/action-log?${q.join(`
- `/v1/proxy/governance/actions/${actionId}/approve`
- `/v1/proxy/governance/actions/${actionId}/reject`
- `/v1/proxy/governance/metrics?days=${days}`
- `/v1/proxy/governance/rollback/${batchId}`
- `/v1/proxy/memories/bulk-delete-by-tag`
- `/v1/proxy/research/sessions`
- `/v1/proxy/research/sessions/${sessionId}/approve`
- `/v1/proxy/research/sessions/${sessionId}/discard`
- `/v1/proxy/swarm/resident/agents/${agentId}/run`
- `/v1/proxy/swarm/resident/cycle`
- `/v1/proxy/swarm/resident/runs/${runId}`
