...
**Group:** Voice · **Route:** `/hivemind/app/tara`
**Status:** UNAUDITED — no production review yet

## Frontend
- `pages/TaraConfig.jsx`

## Backend endpoints called (9)
- `/v1/bootstrap`
- `/v1/proxy/tara/calls/${id}`
- `/v1/proxy/tara/calls?limit=${limit}`
- `/v1/proxy/tara/skills`
- `/v1/proxy/tara/skills/${id}`
- `/v1/proxy/tara/skills/select`
- `/v1/tara/outbound`
- `/v1/tara/outbound/${encodeURIComponent(callLegId)}/hangup`
- `/v1/tara/runtime-config`
