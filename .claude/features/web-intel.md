...
**Group:** AI Features · **Route:** `/hivemind/app/web`
**Status:** UNAUDITED — no production review yet

## Frontend
- `pages/WebIntelligence.jsx`
- `pages/WebStudio.jsx`
- `pages/DeepResearch.jsx`
- `pages/WebAdmin.jsx`

## Backend endpoints called (13)
- `/v1/projects`
- `/v1/proxy/web/admin/metrics`
- `/v1/proxy/web/crawl/jobs`
- `/v1/proxy/web/jobs${qs`
- `/v1/proxy/web/jobs/${jobId}`
- `/v1/proxy/web/jobs/${jobId}/retry`
- `/v1/proxy/web/jobs/${jobId}/save-to-memory`
- `/v1/proxy/web/limits`
- `/v1/proxy/web/policy/check-domain`
- `/v1/proxy/web/research/jobs`
- `/v1/proxy/web/search/jobs`
- `/v1/proxy/web/usage`
- `/v1/proxy/web/usage/monthly`
