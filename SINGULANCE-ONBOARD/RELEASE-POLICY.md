...
At the end of a normal application release, retain only the tags in this table
and remove temporary candidate tags. Docker build cache is disposable after an
image is built; persistent volumes are never pruned.
