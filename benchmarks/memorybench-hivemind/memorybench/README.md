...
ZEP_API_KEY=
HIVEMIND_API_KEY=
HIVEMIND_BASE_URL=http://localhost:3001
...
```
-p, --provider         Memory provider (supermemory, mem0, zep, hivemind)
...
# HIVEMIND provider
bun run src/index.ts run -p hivemind -b longmemeval -j gpt-4o -r hivemind-run
