...
Examples:
  ...
  bun run src/index.ts run -p hivemind -b longmemeval -j gpt-4o -r run-hivemind
...
Available providers for storing and retrieving memories:
  ...
  hivemind       HIVEMIND Memory Engine via REST API
                 Uses /api/memories for ingestion and /api/search/quick for retrieval.
                 Requires: HIVEMIND_API_KEY
                 Optional: HIVEMIND_BASE_URL (default: http://localhost:3001)
...
Usage:
  ...
  -p hivemind       Use HIVEMIND memory engine
`)
}
