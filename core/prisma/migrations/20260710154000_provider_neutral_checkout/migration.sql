...
CREATE INDEX IF NOT EXISTS "billing_checkouts_org_status_created_idx"
  ON "hivemind"."billing_checkouts" ("org_id", "status", "created_at" DESC);
CREATE INDEX IF NOT EXISTS "billing_checkouts_user_created_idx"
  ON "hivemind"."billing_checkouts" ("user_id", "created_at" DESC);
