      ...
      parameters: {
        ...
        properties: {
          operation: {
            type: 'string',
            enum: [...OPERATIONS],
            description: 'Use relation_between whenever the user asks how two or more named entities are connected, related, associated, dependent, compared, or mentioned together in any language. Use aggregate whenever the user needs a complete, exact count or exhaustive list. Use source_read only when the user names a specific file/source. Use recall with recall_mode=explain when the user asks which files or sources mention an entity. Use recall fact only for a bounded direct fact where source reconstruction is unnecessary.',
          },
