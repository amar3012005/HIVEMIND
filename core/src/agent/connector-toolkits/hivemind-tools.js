...
const GROUPS = {
  'hivemind-recall': {
    ...
    tools: new Set(['hivemind_recall', 'hivemind_relation_between', 'hivemind_aggregate_entities', 'hivemind_count_where', 'hivemind_query_table', 'hivemind_get_memory', 'hivemind_list_memories', 'hivemind_traverse_graph', 'hivemind_at', 'hivemind_diff', 'hivemind_timeline', 'hivemind_query_with_ai', 'get_user_profile']),
  },
