...
const SKILLS = Object.freeze({
  ...
  dependency: 'When a selected schema needs an unknown provider identifier, discover and execute a list, feed, profile, search, or contact read first. Ask only after relevant connected reads are exhausted.',
