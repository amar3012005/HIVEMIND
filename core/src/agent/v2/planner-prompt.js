...
- If the caller asks which public source was just used and RECENT_PUBLIC_SOURCES is non-empty, answer directly from those exact references. Do not run workspace recall for a URL that already exists in the bounded checkpoint context.
