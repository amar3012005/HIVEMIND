...
export function brandLockup({ compact = false } = {}) {
  ...
  return `<div class="brand-lockup">${mark}<div><div class="brand-word">SINGULANCE</div><div class="brand-sub">HIVEMIND <span>·</span> OPERATING SYSTEM</div></div></div>`;
}
...
export function lifecycleEmailShell({ title, preheader, body }) {
  const t = CARTESIA;
  ...
  *{box-sizing:border-box}body{margin:0;background:#f1f2ef;color:${t.ink};font-family:${t.sans};overflow-wrap:anywhere}table{border-collapse:collapse}.preheader{display:none!important;visibility:hidden;opacity:0;color:transparent;height:0;width:0}.frame{padding:28px 12px}.shell{width:680px;max-width:680px;table-layout:fixed;background:${t.white};border:1px solid ${t.line}}.head{padding:24px 34px;border-bottom:1px solid ${t.line}}.brand-lockup{display:flex;align-items:center;gap:12px}.brand-word{font-size:24px;line-height:25px;font-weight:800;letter-spacing:-1px}.brand-sub{margin-top:5px;font:700 8px/12px ${t.mono};letter-spacing:2px;color:#999}.brand-sub span{color:${t.blue}}.section{padding:36px 40px;border-bottom:1px solid ${t.line}}.eyebrow{font:700 8px/13px ${t.mono};letter-spacing:2.1px;color:${t.blue};text-transform:uppercase}.h1{margin:15px 0 0;font-size:36px;line-height:38px;letter-spacing:-1.7px}.h2{margin:12px 0 0;font-size:24px;line-height:27px;letter-spacing:-.8px}.copy{margin:14px 0 0;color:${t.body};font-size:14px;line-height:22px}.stats{table-layout:fixed;margin-top:22px;border-top:1px solid ${t.line};border-bottom:1px solid ${t.line}}.stat{padding:14px 12px 14px 0}.stat+.stat{border-left:1px solid ${t.line};padding-left:14px}.stat-label{font:700 7px/11px ${t.mono};letter-spacing:1.2px;color:#999}.stat-value{margin-top:4px;font-size:20px;font-weight:800}.person{padding:10px 0;border-bottom:1px solid #eeeae4}.person:last-child{border-bottom:0}.avatar{width:42px;height:42px;border-radius:50%;overflow:hidden;background:#fff4f8;border:1px solid #f6c5dc}.avatar img{display:block;width:42px;height:42px}.person-name{font-size:14px;font-weight:700}.person-role{margin-top:2px;font:700 9px/13px ${t.mono};letter-spacing:1px;color:#ec4899}.action{display:inline-block;margin-top:18px;padding:12px 18px;background:${t.blue};color:#fff!important;text-decoration:none;font-size:12px;font-weight:700}.footer{padding:18px 34px;font:700 7px/12px ${t.mono};letter-spacing:1.1px;color:#999}
...
export function lifecycleDeckShell({ title, pages }) {
  ...
  @page{size:13.333in 7.5in;margin:0}*{box-sizing:border-box}body{margin:0;background:${t.paper};color:${t.ink};font-family:${t.sans}}.deck-page{position:relative;width:13.333in;height:7.5in;overflow:hidden;background:${t.paper};page-break-after:always}.deck-page:last-child{page-break-after:auto}.deck-head{height:.78in;padding:.19in .52in;border-bottom:1px solid ${t.line};display:flex;align-items:center;justify-content:space-between}.brand-lockup{display:flex;align-items:center;gap:.12in}.brand-lockup svg{width:.38in;height:.38in}.brand-word{font-size:15px;line-height:16px;font-weight:800;letter-spacing:-.6px}.brand-sub{margin-top:3px;font:700 6px/9px ${t.mono};letter-spacing:1.5px;color:#999}.brand-sub span{color:${t.blue}}.folio{font:700 7px/10px ${t.mono};letter-spacing:1.5px;color:${t.blue}}.deck-body{height:6.25in;padding:.52in}.split{display:grid;grid-template-columns:1fr 1fr;gap:.54in;align-items:center;height:100%}.split.reverse>.copy-panel{order:2}.split.reverse>.visual-panel{order:1}.eyebrow{font:700 7px/12px ${t.mono};letter-spacing:2px;color:${t.blue};text-transform:uppercase}.display{margin:.18in 0 0;font-size:39px;line-height:39px;letter-spacing:-2px;max-width:5.1in}.lede{margin:.19in 0 0;max-width:5.1in;font-size:13px;line-height:21px;color:${t.body}}.rule{border-top:1px solid ${t.line};margin:.26in 0}.facts{display:grid;gap:.11in;margin-top:.24in}.fact{font-size:11px;line-height:16px;color:${t.ink};padding-left:.2in;position:relative}.fact:before{content:'✓';position:absolute;left:0;color:${t.blue}}.browser{background:#fff;border:1px solid ${t.line};box-shadow:0 20px 42px rgba(10,10,10,.08)}.browser-top{height:.38in;border-bottom:1px solid ${t.line};padding:.12in .15in;display:flex;align-items:center}.traffic{width:6px;height:6px;border-radius:50%;margin-right:5px}.red{background:#ff6b5f}.amber{background:#f4bc4f}.green{background:#52c66d}.browser-label{margin-left:8px;font:700 6px/10px ${t.mono};letter-spacing:1.3px;color:#999}.browser-body{padding:.25in}.stat-grid{display:grid;grid-template-columns:repeat(3,1fr);border-top:1px solid ${t.line};border-bottom:1px solid ${t.line};margin-top:.32in}.stat{padding:.16in}.stat+.stat{border-left:1px solid ${t.line}}.stat-label{font:700 6px/9px ${t.mono};letter-spacing:1.3px;color:#999}.stat-value{margin-top:5px;font-size:22px;font-weight:800}.roster{display:grid;gap:.12in}.person{display:grid;grid-template-columns:.52in 1fr auto;gap:.13in;align-items:center;padding:.09in 0;border-bottom:1px solid #eeeae4}.person:last-child{border-bottom:0}.person-avatar{width:.48in;height:.48in;border-radius:50%;overflow:hidden;background:#fff4f8;border:1px solid #f6c5dc}.person-avatar svg{display:block;width:100%;height:100%}.person-name{font-size:13px;font-weight:700}.person-role{margin-top:2px;font:700 7px/11px ${t.mono};letter-spacing:1.1px;color:#ec4899}.person-one-line{font-size:8px;line-height:12px;color:${t.body};max-width:2.1in}.card-list{display:grid;gap:.1in}.card{padding:.14in .16in;border:1px solid ${t.line};background:#fff}.card-kicker{font:700 6px/9px ${t.mono};letter-spacing:1.2px;color:${t.blue}}.card-title{margin-top:4px;font-size:11px;line-height:14px;font-weight:700}.card-copy{margin-top:3px;font-size:8px;line-height:12px;color:${t.body}}.big-word{position:absolute;left:-.1in;right:-.1in;bottom:.12in;white-space:nowrap;font-size:58px;line-height:60px;font-weight:800;letter-spacing:-3px;color:transparent;-webkit-text-stroke:1px #d9d6cf}.stripe{height:.3in;border-top:1px solid ${t.line};border-bottom:1px solid ${t.line};background:repeating-linear-gradient(90deg,transparent 0,transparent 2px,rgba(0,0,0,.035) 2px,rgba(0,0,0,.035) 3px)}
