...
export const DAY_ZERO_REPORT_VERSION = 'day-0-v4';
...
function portraitDayZeroReport(report) {
  ...
  @page{size:A4 portrait;margin:0}*{box-sizing:border-box}body{margin:0;background:${CARTESIA.paper};color:${CARTESIA.ink};font-family:Arial,"Noto Sans","Segoe UI Symbol",sans-serif;overflow-wrap:anywhere}.page{padding:12mm 15mm 8mm;background:linear-gradient(180deg,#f4f8ff 0,#fff 31mm,#fff 100%)}.head{display:flex;align-items:center;justify-content:space-between;padding-bottom:5mm;border-bottom:1px solid ${CARTESIA.line}}.brand-lockup{display:flex;align-items:center;gap:3mm}.brand-lockup svg{width:10mm;height:10mm}.brand-word{font-size:18px;font-weight:800;letter-spacing:-.6px}.brand-sub{margin-top:2px;font:700 6px/9px ${CARTESIA.mono};letter-spacing:1.3px;color:#999}.brand-sub span{color:${CARTESIA.blue}}.folio{font:700 7px/10px ${CARTESIA.mono};letter-spacing:1.5px;color:${CARTESIA.blue}}.hero{padding:9mm 0 7mm;border-bottom:1px solid ${CARTESIA.line};break-inside:avoid;page-break-inside:avoid}.eyebrow,.kicker{font:700 7px/11px ${CARTESIA.mono};letter-spacing:1.5px;color:${CARTESIA.blue};text-transform:uppercase}h1{margin:3mm 0 0;font-size:31px;line-height:1.03;letter-spacing:-1.25px}.lede{max-width:168mm;margin:4mm 0 0;color:${CARTESIA.body};font-size:11px;line-height:17px}.stats{display:grid;grid-template-columns:repeat(3,1fr);margin-top:6mm;border:1px solid ${CARTESIA.line}}.stat{padding:4mm}.stat+.stat{border-left:1px solid ${CARTESIA.line}}.stat b{display:block;font-size:24px}.stat span{font:700 6px/9px ${CARTESIA.mono};letter-spacing:1px;color:#888}.founder{margin-top:5mm;padding:5mm;background:#101010;color:#fff;break-inside:avoid;page-break-inside:avoid}.founder q{font-size:13px;line-height:19px;font-weight:700}.founder div{margin-top:3mm;font:700 6px/9px ${CARTESIA.mono};letter-spacing:1.1px;color:#83b6ed}.section{padding-top:7mm;break-before:auto}.section-head{margin-bottom:4mm;break-after:avoid;page-break-after:avoid}.section h2{margin:2mm 0 0;font-size:22px;line-height:1.1;letter-spacing:-.6px}.grid{display:grid;grid-template-columns:1fr 1fr;gap:4mm}.card,.agent,.item,.source,.profile-row{break-inside:avoid;page-break-inside:avoid}.card{border:1px solid ${CARTESIA.line};padding:5mm;background:#fff}.card h3{margin:2mm 0;font-size:15px;line-height:19px}.card p,.profile-row,.item-copy,.agent-copy{margin:0;color:${CARTESIA.body};font-size:9px;line-height:14px}.profile{display:grid;gap:3mm}.profile-row{padding-bottom:3mm;border-bottom:1px solid ${CARTESIA.line}}.profile-row>div:last-child{margin-top:1mm;color:${CARTESIA.ink}}.agents{display:grid;grid-template-columns:1fr 1fr;gap:3mm}.agent{display:grid;grid-template-columns:15mm 1fr;gap:3mm;padding:4mm;border:1px solid ${CARTESIA.line};background:#fff}.agent-avatar{width:14mm;height:14mm;border:1px solid;border-radius:50%;overflow:hidden}.agent-avatar svg{display:block;width:100%;height:100%}.agent-name{font-size:11px;font-weight:800}.agent-role{margin-top:1px;font:700 6px/9px ${CARTESIA.mono};letter-spacing:.8px}.agent-copy{margin-top:2mm}.items{display:grid;gap:3mm}.item{display:grid;grid-template-columns:10mm 1fr;gap:3mm;padding:4mm;border:1px solid ${CARTESIA.line}}.number{font:700 10px/14px ${CARTESIA.mono};color:${CARTESIA.blue}}.item-title{margin-top:1mm;font-size:12px;line-height:16px;font-weight:800}.item-copy{margin-top:1mm}.review{padding:5mm;background:#f4f8ff;border-left:2px solid ${CARTESIA.blue};break-inside:avoid;page-break-inside:avoid}.review ul{margin:3mm 0 0;padding-left:5mm;font-size:9px;line-height:14px}.sources{display:grid;gap:0}.source{display:grid;grid-template-columns:10mm 1fr;gap:2mm;padding:3mm 0;border-top:1px solid ${CARTESIA.line};font-size:8px;line-height:12px}.source>span{font:700 7px/11px ${CARTESIA.mono};color:${CARTESIA.blue}}.source a{color:${CARTESIA.body};text-decoration:none;word-break:break-all}.cta{margin-top:7mm;padding:6mm;background:${CARTESIA.blue};color:#fff;break-inside:avoid;page-break-inside:avoid}.cta h2{margin:0;font-size:22px}.cta p{margin:2mm 0 0;font-size:10px;line-height:15px}.cta a{display:inline-block;margin-top:4mm;color:#fff;font:700 8px/11px ${CARTESIA.mono};letter-spacing:1px;text-decoration:none}.foot{margin-top:3mm;padding-top:2mm;border-top:1px solid ${CARTESIA.line};display:flex;justify-content:space-between;font:700 6px/9px ${CARTESIA.mono};letter-spacing:1.1px;color:#999;break-inside:avoid;page-break-inside:avoid}.foot a{color:${CARTESIA.blue};text-decoration:none}
  </style></head><body><main class="page"><header class="head">${brandLockup({ compact: true })}<div class="folio">DAY-0 / AWAKENING</div></header><section class="hero"><div class="eyebrow">DAY 0 · THE RISE OF AWAKENING</div><h1>${escapeHtml(report.companyName)}<br>has awakened.</h1><p class="lede">HIVEMIND read your public company context, shaped its first operating model, and prepared the people and first moves now waiting inside your workspace.</p><div class="stats"><div class="stat"><b>${report.sourceCount}</b><span>SOURCES READ</span></div><div class="stat"><b>${report.taskCount}</b><span>FIRST MOVES</span></div><div class="stat"><b>${report.teamCount}</b><span>HYPERAGENTS</span></div></div><div class="founder"><q>Welcome to the world of SINGULANCE. Congratulations on being among the first to onboard your company with us. Here’s to the future—and a new way of running your company.</q><div>AMAR SAI GADDE · FOUNDER &amp; CEO</div></div></section><section class="section"><div class="section-head"><div class="eyebrow">COMPANY SIGNAL</div><h2>The first working model of ${escapeHtml(report.companyName)}.</h2></div><div class="grid"><div class="card"><div class="kicker">WHAT YOU DO</div><h3>${escapeHtml(report.tagline || report.companyName)}</h3><p>${escapeHtml(report.whatItDoes || report.positioning || 'Your company model is ready for review.')}</p></div><div class="card"><div class="kicker">WHO YOU SERVE</div><h3>${escapeHtml(report.websiteHost || report.companyName)}</h3><p>${escapeHtml(report.icp || 'Your initial customer hypothesis is ready for validation.')}</p></div></div>${profile ? `<div class="profile" style="margin-top:4mm">${profile}</div>` : ''}</section><section class="section"><div class="section-head"><div class="eyebrow">HIVEMIND · HYPERAGENTS</div><h2>Your recruited operating team.</h2></div><div class="agents">${roster || '<div class="card">Your first HyperAgent can be recruited from the workspace.</div>'}</div></section><section class="section"><div class="section-head"><div class="eyebrow">FIRST COMPANY MOVES</div><h2>Work waiting to become real.</h2></div><div class="items">${moves || '<div class="card">Your first company actions are ready.</div>'}</div></section><section class="section"><div class="section-head"><div class="eyebrow">HUMAN JUDGEMENT</div><h2>The model knows where it needs you.</h2></div><div class="review"><div class="kicker">CONFIRM NEXT</div><ul>${confirmations}</ul></div></section><section class="section"><div class="section-head"><div class="eyebrow">EVIDENCE LEDGER</div><h2>Public context used during awakening.</h2></div><div class="sources">${sources || '<div class="card">No public source URL was retained.</div>'}</div></section><section class="cta"><h2>Your company is waiting.</h2><p>Review what HIVEMIND learned, correct anything that needs your judgement, and open the first task that matters.</p><a href="${escapeHtml(report.reportUrl)}">ENTER YOUR WORKSPACE →</a></section><footer class="foot"><span>SINGULANCE · YOUR COMPANY, IN MOTION</span><a href="${escapeHtml(report.reportUrl)}">OPEN YOUR COMPANY →</a></footer></main></body></html>`;
}

export function renderDayZeroOnboardingReportHtml(input, options = {}) {
  const report = buildDayZeroOnboardingReport(input, options);
  return { report, html: portraitDayZeroReport(report) };
}
