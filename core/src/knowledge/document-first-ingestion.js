...
// This is the typed entity contract emitted by the primary unified extractor.
// Keep it in parity with EntityExtractor and the canonical entity registry: a
// named project, operational system, or named event is searchable context, not
// an anonymous "topic".  We deliberately do not admit generic concepts here.
const CLAIM_ENTITY_KINDS = new Set([
  'person', 'organization', 'project', 'product', 'place', 'technology',
...
{"entities":[{"n":"Canonical Name","k":"person|organization|project|product|place|technology|standard|system|event","aliases":["exact source variant"],"confidence":0.0}],"facts":[{"t":"short topic","f":"one complete standalone contextual claim","memory_type":"fact|event","claim_kind":"fact|event|decision|preference|policy|goal|commitment|procedure|lesson","importance":0.0,"extraction_confidence":0.0,"source_quote":"exact verbatim substring from SECTION","subject":{"n":"exact canonical subject","k":"person|organization|project|product|place|technology|standard|system|event"},"predicate":"canonical_english_relation","object":{"value":"exact source-language value","type":"semantic category or empty"},"qualifiers":{"scope":"only material conditions, dates, units, negation, uncertainty or rationale"},"entities":[{"n":"Canonical Name","k":"person|organization|project|product|place|technology|standard|system|event"}],"relationships":[{"from":{"n":"Canonical Name","k":"allowed kind"},"type":"semantic_relation","to":{"n":"Canonical Name","k":"allowed kind"}}]}]}
...
{"memories":[{"title":"short descriptive title","memory_type":"fact|event|summary|synthesis","claim_kind":"fact|event|decision|preference|policy|goal|commitment|procedure|lesson|summary|synthesis","content":"1-3 source-grounded sentences","claim_subject":{"n":"canonical subject","k":"person|organization|project|product|place|technology|standard|system|event"},"claim_predicate":"canonical_english_relation","claim_object":{"value":"exact source-language value","type":"semantic category or empty"},"claim_qualifiers":{"scope":"only material conditions, dates, units, negation, uncertainty or rationale"},"support_indices":[0,1]}]}
