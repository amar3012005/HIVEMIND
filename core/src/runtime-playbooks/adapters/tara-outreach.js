      ...
      artifacts.push({
        ...
        data: {
          ...
          activity_marker: {
            ...
            kind: 'call_started',
            headline: 'TARA outreach call started',
            note: `The governed call to ${contract?.data?.prospect || contract?.data?.phone || 'the selected contact'} is now in progress.`,
            occurred_at: new Date().toISOString(),
            call: {
              prospect: contract?.data?.prospect || null,
              phone: contract?.data?.phone || null,
              goal: contract?.data?.goal || null,
