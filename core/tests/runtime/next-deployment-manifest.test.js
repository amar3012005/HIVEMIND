...
test('vNext deployment separates B2B and B2C app/control/worker pools', () => {
  ...
  assert.match(text, /HIVEMIND_CONTROL_PLANE_PUBLIC_URL: https:\/\/b2b-next-api\.singulancelabs\.com/);
  assert.match(text, /HIVEMIND_CORE_API_PUBLIC_URL: https:\/\/b2c-next-core\.singulancelabs\.com/);
