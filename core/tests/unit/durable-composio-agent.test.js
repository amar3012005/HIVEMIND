...
test('durable agent is controlled solely by Flagship and fails closed', async () => {
  const env = { USE_TOOLS_DURABLE_AGENT_FLAG_URL: 'https://flags.test/use-tools-durable-agent' };
