...
The progressive durable turn uses one model: `openai/gpt-oss-20b:nitro`, with low reasoning effort, for intent, action selection, semantic argument validation and schema argument generation. Gemini and DeepSeek are not progressive-harness fallbacks.
