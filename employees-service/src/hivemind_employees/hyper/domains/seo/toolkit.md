...
- Use the shared crawler, browser runtime, web job store, tenant policy, and audit system. SEO skills add interpretation; they do not create parallel infrastructure.
- Never execute a website change during analysis. Produce scoped fixes and verification steps; connected write tools remain governed by existing approval policy.
