...
_OR_PROVIDER_PIN = {
    ...
    # Groq is allowed only as an OpenRouter-selected host. Requests still use
    # our OpenRouter key and pass through Cloudflare AI Gateway; HyperAgents
    # never calls api.groq.com directly.
    "openai/gpt-oss-120b": ["Groq", "Cerebras", "Together"],
    "openai/gpt-oss-20b": ["Groq", "Novita"],
    HYPER_FAST_MODEL: ["Groq", "Novita"],
    "openai/gpt-oss": ["Groq", "Cerebras"],
    "qwen/": ["Alibaba"],
...
class Director:
    ...
    async def _plan_gather(self) -> Dict[str, Any]:
        ...
        # before visual routing so the planning model cannot silently substitute
        # a report for email, slides, a document, spreadsheet, or image.
