    ...
    async def _plan_gather(self) -> Dict[str, Any]:
        ...
        if _visual_artifacts_enabled():
            ...
            sysp += (
                ...
                " When the ACTIVE request explicitly requires a final artifact, reviewed artifact, reusable "
                "artifact, visual report, or comparable durable deliverable without naming slides or a dashboard, "
                "artifact_intent MUST be a non-null interactive_document. Do not downgrade an explicitly requested "
                "artifact to answer-only prose merely because research is required first."
