...
3. Specify composition, viewpoint, focal hierarchy, camera and lens language, lighting, environment, materials, and responsive-crop safe area.
...
5. Identify the audience, color direction, visual references, and the emotional interpretation the creative should produce.
...
9. Finish with one detailed generation prompt that is self-contained, describes concrete spatial relationships, and does not refer to earlier discussion.
