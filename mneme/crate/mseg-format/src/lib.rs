...
pub use header::{
    ...
    EDGE_MENTIONS, EDGE_NONE, EDGE_PARTOF, EDGE_SLOTS, EDGE_UPDATES, FILE_HEADER_SIZE,
    FORMAT_VERSION, MAGIC, MAX_TEXT_BYTES, SENTINEL_U32, SLOT_REGION_OFFSET, SLOT_SIZE,
    VECTOR_PQ_LEN,
};
