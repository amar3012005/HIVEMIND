...
TARA_GROK_MODEL = os.environ.get("TARA_GROK_MODEL", "grok-voice-think-fast-2.0").strip()
...
def ready_error() -> str | None:
    ...
    if TARA_GROK_MODEL != "grok-voice-think-fast-2.0":
        return "TARA_GROK_MODEL must pin grok-voice-think-fast-2.0"
