/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e016f695299dad8e224baaf75ee690a8)
// Runtime types generated with workerd@1.20260828.1 2026-08-29 nodejs_compat
interface __BaseEnv_Env {
	LIFECYCLE_ADMISSION: Queue;
	FLAGS: Flagship;
	HIVEMIND_CONTROL_URL: "https://preview-api.singulancelabs.com" | "https://api.singulancelabs.com";
	HIVEMIND_D1_INSTANCE_PREFIX?: "d1-local7";
	HIVEMIND_D1_RECONCILE_LIMIT: "500";
	DAY1_WORKFLOW: Workflow<Parameters<import("./src/index").DayOneWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	...
	interface LocalEnv {
		LIFECYCLE_ADMISSION: Queue;
		FLAGS: Flagship;
		HIVEMIND_CONTROL_URL: "https://preview-api.singulancelabs.com";
		HIVEMIND_D1_INSTANCE_PREFIX: "d1-local7";
		HIVEMIND_D1_RECONCILE_LIMIT: "500";
		DAY1_WORKFLOW: Workflow<Parameters<import("./src/index").DayOneWorkflow['run']>[0]['payload']>;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "HIVEMIND_CONTROL_URL" | "HIVEMIND_D1_INSTANCE_PREFIX" | "HIVEMIND_D1_RECONCILE_LIMIT">> {}
}
