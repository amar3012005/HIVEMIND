/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2161a8088c72e3271f71603bbe65838e)
// Runtime types generated with workerd@1.20260828.1 2026-08-29 nodejs_compat
interface __BaseEnv_Env {
	DREAM_ARTIFACTS: R2Bucket;
	DREAM_TRIGGER_QUEUE: Queue;
	FLAGS: Flagship;
	HIVEMIND_DREAM_API_URL: "https://preview-api.singulancelabs.com" | "https://api.singulancelabs.com";
	HIVEMIND_DREAM_INSTANCE_PREFIX: "dream-local" | "dream";
	DREAM_WORKFLOW: Workflow<Parameters<import("./src/index").DreamWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	...
	interface LocalEnv {
		...
		DREAM_TRIGGER_QUEUE: Queue;
		FLAGS: Flagship;
		HIVEMIND_DREAM_API_URL: "https://preview-api.singulancelabs.com";
		HIVEMIND_DREAM_INSTANCE_PREFIX: "dream-local";
		DREAM_WORKFLOW: Workflow<Parameters<import("./src/index").DreamWorkflow['run']>[0]['payload']>;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "HIVEMIND_DREAM_API_URL" | "HIVEMIND_DREAM_INSTANCE_PREFIX">> {}
}
