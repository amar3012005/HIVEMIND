/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1b4d90e9eaac04d9e50a98a3ae6a252d)
// Runtime types generated with workerd@1.20260828.1 2026-08-29 nodejs_compat
interface __BaseEnv_Env {
	HIVEMIND_AGENT_MEMORY_TOKEN: string;
	PROJECT_MEMORY: DurableObjectNamespace<import("./src/index").ProjectMemory>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ProjectMemory";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "HIVEMIND_AGENT_MEMORY_TOKEN">> {}
}
